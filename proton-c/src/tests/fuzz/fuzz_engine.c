...
int test_free_connection(const uint8_t *Data, size_t Size)
{
//     fprintf(stdout, "test_free_connection\n");
    ...
    pn_link_send(tx, (const char *) Data, Size);
    pn_link_advance(tx);
...
int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
    test_free_connection(Data, Size);
